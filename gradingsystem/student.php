...
<body>
    ...
    <div class="header__middle">
        <div class="header__option tooltip" onclick="showFaculty()">
            <span class="material-icons"> group </span>
        </div>
        <div class="header__option tooltip" onclick="showAdmin()">
            <span class="material-icons"> group </span>
        </div>
        <div class="header__option tooltip" onclick="showManageClass()">
            <span class="material-icons"> group </span>
        </div>
    </div>
...
`;
    ...
    `;
        ...
        // Call showFaculty() to render the teachers table on page load
